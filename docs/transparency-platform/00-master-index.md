...
| ENGINEERING BUILD (post-gate) | Execute Phase-6 specs on **synthetic data** through SRR→PRR; **prod go-live blocked** by Readiness Gate (`phase2/05`) + Go-Live Gate (`phase3/08`) + OB sign-off; 🔒 subsystems human-expert-built | Ready to start on synthetic data |
