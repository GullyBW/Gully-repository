...
| ENGINEERING (post-gate) | Full per-context specs + complete OpenAPI/schemas/IaC/CI-CD/runbooks · sprint/milestone plan — **build on synthetic data may start; prod go-live blocked by gates** | Gated by Readiness Gate (`phase2/05`) + Go-Live Gate (`phase3/08`) + OB sign-off |
