...
test('an ADR with no review schedule is unscheduled, and one with no date is undated', () => {
  ...
  // Phase 13 with a 2027-02-04 review date, ADR-0009 in Phase 14 with 2027-02-05, and ADR-0010 and
  // ADR-0011 in Phases 15 and 16 with 2027-02-06 — deliberately adjacent, because the invariants are
  // one question and reviewing them apart would invite divergence — so all five are overdue here.
  assert.deepStrictEqual(adr.dueForReview({ now: '2027-06-01' }).overdue, [7, 8, 9, 10, 11]);
});
