...
function controlOwnership(fitnessIds = []) {
  const byPrefix = [
    ...
    { match: /^APP-FIT-SRE|^APP-FIT-OBSERVABILITY|^APP-FIT-EXECUTIVE|^APP-FIT-BUSINESS|^APP-FIT-MISSION|^APP-FIT-INSTITUTIONAL-CHAIN/, context: 'observability' },
    ...
    { match: /^APP-FIT-LEGISLATIVE|^APP-FIT-COMPLIANCE-INTELLIGENCE|^APP-FIT-COMPLIANCE-LIFECYCLE/, context: 'legislation' },
    { match: /^APP-FIT-AI/, context: 'ai-advisory' },
    { match: /^APP-FIT-THREAT|^APP-FIT-DEVSECOPS|^APP-FIT-RISK/, context: 'security' },
    { match: /^INFRA-FIT|^APP-FIT-INFRA|^APP-FIT-RUNBOOK|^APP-FIT-DOCUMENTATION-ASSURANCE/, context: 'infrastructure' },
    { match: /^APP-FIT-CONTEXT-MAP|^APP-FIT-ARCHITECTURE-DRIFT|^APP-FIT-MIGRATION|^APP-FIT-ADR|^APP-FIT-ASSUMPTION|^APP-FIT-DECISION-MEMORY|^APP-FIT-CONTINUOUS-ASSURANCE|^APP-FIT-INSTITUTIONAL-ASSURANCE|^APP-FIT-EVIDENCE|^APP-FIT-EVIDENCE-QUALITY|^APP-FIT-READINESS|^APP-FIT-ENGINEERING|^APP-FIT-ENTERPRISE|^APP-FIT-TEMPORAL-GRAPH|^FIT-AUDITABILITY/, context: 'assurance' },
    { match: /^APP-FIT-INTEGRATION-CONTRACTS|^APP-FIT-CONSUMER|^APP-FIT-API/, context: 'api-governance' },
    { match: /^APP-FIT-GOVERNANCE|^APP-FIT-KNOWLEDGE-CONTINUITY|^APP-FIT-GOVERNANCE-REHEARSALS|^APP-FIT-INSTITUTIONAL-RESILIENCE|^APP-FIT-RACI|^FIT-GOVERNANCE|^APP-FIT-EVOLUTION|^APP-FIT-COMMAND/, context: 'governance-oversight' },
