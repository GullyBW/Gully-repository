...
function controlOwnership(fitnessIds = []) {
  const byPrefix = [
    ...
    { match: /^APP-FIT-GOVERNANCE|^APP-FIT-KNOWLEDGE-CONTINUITY|^APP-FIT-GOVERNANCE-REHEARSALS|^APP-FIT-EXERCISE-INTELLIGENCE|^APP-FIT-CAPABILITY-MATURITY|^APP-FIT-CAPABILITY-ROADMAP|^APP-FIT-CAPABILITY-EVOLUTION|^APP-FIT-INSTITUTIONAL-RESILIENCE|^APP-FIT-GOVERNANCE-RESILIENCE|^APP-FIT-GOVERNANCE-SUCCESSION|^APP-FIT-GOVERNANCE-CAPABILITY-DRIFT|^APP-FIT-GLOBAL-INVARIANT|^APP-FIT-DEPENDENCY-RISK|^APP-FIT-DEPENDENCY-INTELLIGENCE|^APP-FIT-GOVERNANCE-OPTIMIZATION|^APP-FIT-RECOMMENDATION-CLASSIFICATION|^APP-FIT-CROSS-AGENCY|^APP-FIT-CROSS-GOVERNMENT|^APP-FIT-WORKFLOW-VALIDATION|^APP-FIT-WORKFLOW-INTELLIGENCE|^APP-FIT-RACI|^FIT-GOVERNANCE|^APP-FIT-EVOLUTION|^APP-FIT-COMMAND/, context: 'governance-oversight' },
