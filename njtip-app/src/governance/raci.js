...
function controlOwnership(fitnessIds = []) {
  const byPrefix = [
    ...
    { match: /^APP-FIT-SRE|^APP-FIT-OBSERVABILITY|^APP-FIT-EXECUTIVE|^APP-FIT-BUSINESS|^APP-FIT-MISSION|^APP-FIT-INSTITUTIONAL-CHAIN|^APP-FIT-TEMPORAL-MISSION-IMPACT|^APP-FIT-PUBLIC-TRUST/, context: 'observability' },
    { match: /^APP-FIT-CHAOS|^APP-FIT-RESILIENCE|^APP-FIT-NATIONAL-RESILIENCE|^APP-FIT-RECOVERY|^APP-FIT-MULTI-REGION|^APP-FIT-CONSISTENCY|^APP-FIT-CRISIS|^APP-FIT-OPERATIONS-TWIN|^APP-FIT-ORGANIZATIONAL-TWIN|^APP-FIT-TWIN-CONFIDENCE|^APP-FIT-STRATEGIC-SCENARIOS/, context: 'resilience' },
    ...
    { match: /^APP-FIT-CONTEXT-MAP|^APP-FIT-ZONE-GOVERNANCE|^APP-FIT-ARCHITECTURE-DRIFT|^APP-FIT-DRIFT-CLASSIFICATION|^APP-FIT-ADAPTIVE-ANALYTICS|^APP-FIT-MIGRATION|^APP-FIT-ADR|^APP-FIT-ASSUMPTION|^APP-FIT-ASSUMPTION-MATURITY|^APP-FIT-DECISION-MEMORY|^APP-FIT-DECISION-EVOLUTION|^APP-FIT-CONTINUOUS-ASSURANCE|^APP-FIT-INSTITUTIONAL-ASSURANCE|^APP-FIT-INSTITUTIONAL-LEARNING|^APP-FIT-STRATEGIC-INTELLIGENCE|^APP-FIT-CONTROL-EFFECTIVENESS|^APP-FIT-STATISTICAL-CONFIDENCE|^APP-FIT-EVIDENCE|^APP-FIT-EVIDENCE-QUALITY|^APP-FIT-READINESS|^APP-FIT-ENGINEERING|^APP-FIT-ENTERPRISE|^APP-FIT-TEMPORAL-GRAPH|^FIT-AUDITABILITY/, context: 'assurance' },
    { match: /^APP-FIT-INTEGRATION-CONTRACTS|^APP-FIT-CONSUMER|^APP-FIT-API/, context: 'api-governance' },
    { match: /^APP-FIT-GOVERNANCE|^APP-FIT-KNOWLEDGE-CONTINUITY|^APP-FIT-GOVERNANCE-REHEARSALS|^APP-FIT-INSTITUTIONAL-RESILIENCE|^APP-FIT-GLOBAL-INVARIANT|^APP-FIT-DEPENDENCY-RISK|^APP-FIT-DEPENDENCY-INTELLIGENCE|^APP-FIT-GOVERNANCE-OPTIMIZATION|^APP-FIT-CROSS-AGENCY|^APP-FIT-RACI|^FIT-GOVERNANCE|^APP-FIT-EVOLUTION|^APP-FIT-COMMAND/, context: 'governance-oversight' },
    { match: /^APP-FIT-CORRELATION|^APP-FIT-PLATFORM-INTELLIGENCE/, context: 'intelligence' },
    { match: /^APP-FIT-USABILITY|^APP-FIT-SUSTAINABILITY/, context: 'portfolio' },
    ...
    { match: /^APP-FIT-GRAPH|^APP-FIT-SEMANTIC/, context: 'analytics' },
