...
function controlOwnership(fitnessIds = []) {
  const byPrefix = [
    ...
    { match: /^APP-FIT-CONTEXT-MAP|^APP-FIT-ZONE-GOVERNANCE|^APP-FIT-ARCHITECTURE-DRIFT|^APP-FIT-DRIFT-CLASSIFICATION|^APP-FIT-ADAPTIVE-ANALYTICS|^APP-FIT-MIGRATION|^APP-FIT-ADR|^APP-FIT-ASSUMPTION|^APP-FIT-ASSUMPTION-MATURITY|^APP-FIT-DECISION-MEMORY|^APP-FIT-DECISION-EVOLUTION|^APP-FIT-CONTINUOUS-ASSURANCE|^APP-FIT-INSTITUTIONAL-ASSURANCE|^APP-FIT-INSTITUTIONAL-LEARNING|^APP-FIT-STRATEGIC-INTELLIGENCE|^APP-FIT-EVIDENCE|^APP-FIT-EVIDENCE-QUALITY|^APP-FIT-READINESS|^APP-FIT-ENGINEERING|^APP-FIT-ENTERPRISE|^APP-FIT-TEMPORAL-GRAPH|^FIT-AUDITABILITY/, context: 'assurance' },
