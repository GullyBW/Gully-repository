...
function controlOwnership(fitnessIds = []) {
  const byPrefix = [
    ...
    { match: /^APP-FIT-SRE|^APP-FIT-OBSERVABILITY|^APP-FIT-EXECUTIVE|^APP-FIT-BUSINESS|^APP-FIT-MISSION|^APP-FIT-INSTITUTIONAL-CHAIN|^APP-FIT-TEMPORAL-MISSION-IMPACT/, context: 'observability' },
    { match: /^APP-FIT-CHAOS|^APP-FIT-RESILIENCE|^APP-FIT-NATIONAL-RESILIENCE|^APP-FIT-RECOVERY|^APP-FIT-MULTI-REGION|^APP-FIT-CONSISTENCY|^APP-FIT-CRISIS|^APP-FIT-OPERATIONS-TWIN|^APP-FIT-ORGANIZATIONAL-TWIN|^APP-FIT-TWIN-CONFIDENCE/, context: 'resilience' },
    ...
    { match: /^APP-FIT-CONTEXT-MAP|^APP-FIT-ARCHITECTURE-DRIFT|^APP-FIT-DRIFT-CLASSIFICATION|^APP-FIT-MIGRATION|^APP-FIT-ADR|^APP-FIT-ASSUMPTION|^APP-FIT-DECISION-MEMORY|^APP-FIT-DECISION-EVOLUTION|^APP-FIT-CONTINUOUS-ASSURANCE|^APP-FIT-INSTITUTIONAL-ASSURANCE|^APP-FIT-EVIDENCE|^APP-FIT-EVIDENCE-QUALITY|^APP-FIT-READINESS|^APP-FIT-ENGINEERING|^APP-FIT-ENTERPRISE|^APP-FIT-TEMPORAL-GRAPH|^FIT-AUDITABILITY/, context: 'assurance' },
