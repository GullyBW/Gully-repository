...
function controlOwnership(fitnessIds = []) {
  const byPrefix = [
    ...
    { match: /^APP-FIT-CHAOS|^APP-FIT-RESILIENCE|^APP-FIT-NATIONAL-RESILIENCE|^APP-FIT-RECOVERY|^APP-FIT-MULTI-REGION|^APP-FIT-CONSISTENCY|^APP-FIT-CRISIS|^APP-FIT-OPERATIONS-TWIN|^APP-FIT-ORGANIZATIONAL-TWIN|^APP-FIT-TWIN-CONFIDENCE|^APP-FIT-TWIN-CALIBRATION|^APP-FIT-STRATEGIC-SCENARIOS/, context: 'resilience' },
    ...
    { match: /^APP-FIT-LEGISLATIVE|^APP-FIT-COMPLIANCE-INTELLIGENCE|^APP-FIT-COMPLIANCE-LIFECYCLE|^APP-FIT-COMPLIANCE-TRANSITIONS|^APP-FIT-REGULATORY-FORECAST|^APP-FIT-LEGAL-AUTHORITY|^APP-FIT-LEGAL-DEPENDENCY-INTELLIGENCE/, context: 'legislation' },
    ...
    { match: /^APP-FIT-CONTEXT-MAP|^APP-FIT-ZONE-GOVERNANCE|^APP-FIT-ARCHITECTURE-DRIFT|^APP-FIT-ARCHITECTURE-VALIDATION|^APP-FIT-DRIFT-CLASSIFICATION|^APP-FIT-ADAPTIVE-ANALYTICS|^APP-FIT-FORECAST-CALIBRATION|^APP-FIT-MIGRATION|^APP-FIT-PRODUCTION-TRANSITION|^APP-FIT-ADR|^APP-FIT-ASSUMPTION|^APP-FIT-ASSUMPTION-MATURITY|^APP-FIT-DECISION-MEMORY|^APP-FIT-DECISION-EVOLUTION|^APP-FIT-DECISION-SUPPORT|^APP-FIT-INSTITUTIONAL-SUSTAINABILITY|^APP-FIT-CONTINUOUS-ASSURANCE|^APP-FIT-INSTITUTIONAL-ASSURANCE|^APP-FIT-INSTITUTIONAL-PERFORMANCE|^APP-FIT-TRACEABILITY-INVARIANT|^APP-FIT-EVIDENCE-ONBOARDING|^APP-FIT-EVIDENCE-ACQUISITION|^APP-FIT-INSTITUTIONAL-LEARNING|^APP-FIT-VALIDATION-WORKSHOP|^APP-FIT-STRATEGIC-INTELLIGENCE|^APP-FIT-CONTROL-EFFECTIVENESS|^APP-FIT-CONTROL-PERFORMANCE|^APP-FIT-STATISTICAL-CONFIDENCE|^APP-FIT-EVIDENCE|^APP-FIT-EVIDENCE-QUALITY|^APP-FIT-VERIFIED-IMPROVEMENT|^APP-FIT-SOURCE-HEALTH|^APP-FIT-EXPLAINABILITY|^APP-FIT-READINESS-TRACEABILITY|^APP-FIT-READINESS|^APP-FIT-ENGINEERING|^APP-FIT-ENTERPRISE|^APP-FIT-TEMPORAL-GRAPH|^FIT-AUDITABILITY/, context: 'assurance' },
    { match: /^APP-FIT-INTEGRATION-CONTRACTS|^APP-FIT-CONSUMER|^APP-FIT-API/, context: 'api-governance' },
    { match: /^APP-FIT-GOVERNANCE|^APP-FIT-KNOWLEDGE-CONTINUITY|^APP-FIT-GOVERNANCE-REHEARSALS|^APP-FIT-EXERCISE-INTELLIGENCE|^APP-FIT-CAPABILITY-MATURITY|^APP-FIT-INSTITUTIONAL-RESILIENCE|^APP-FIT-GLOBAL-INVARIANT|^APP-FIT-DEPENDENCY-RISK|^APP-FIT-DEPENDENCY-INTELLIGENCE|^APP-FIT-GOVERNANCE-OPTIMIZATION|^APP-FIT-RECOMMENDATION-CLASSIFICATION|^APP-FIT-CROSS-AGENCY|^APP-FIT-CROSS-GOVERNMENT|^APP-FIT-WORKFLOW-VALIDATION|^APP-FIT-RACI|^FIT-GOVERNANCE|^APP-FIT-EVOLUTION|^APP-FIT-COMMAND/, context: 'governance-oversight' },
