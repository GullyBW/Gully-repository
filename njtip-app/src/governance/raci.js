...
function controlOwnership(fitnessIds = []) {
  const byPrefix = [
    ...
    { match: /^APP-FIT-LEGISLATIVE|^APP-FIT-COMPLIANCE-INTELLIGENCE|^APP-FIT-COMPLIANCE-LIFECYCLE|^APP-FIT-COMPLIANCE-TRANSITIONS|^APP-FIT-REGULATORY-FORECAST/, context: 'legislation' },
