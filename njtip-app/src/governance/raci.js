...
function controlOwnership(fitnessIds = []) {
  const byPrefix = [
    ...
    { match: /^APP-FIT-SRE|^APP-FIT-OBSERVABILITY|^APP-FIT-EXECUTIVE|^APP-FIT-BUSINESS|^APP-FIT-MISSION/, context: 'observability' },
    ...
    { match: /^APP-FIT-LEGISLATIVE|^APP-FIT-COMPLIANCE-INTELLIGENCE/, context: 'legislation' },
    ...
    { match: /^APP-FIT-CONTEXT-MAP|^APP-FIT-MIGRATION|^APP-FIT-ADR|^APP-FIT-ASSUMPTION|^APP-FIT-CONTINUOUS-ASSURANCE|^APP-FIT-EVIDENCE|^APP-FIT-READINESS|^APP-FIT-ENGINEERING|^APP-FIT-ENTERPRISE|^FIT-AUDITABILITY/, context: 'assurance' },
