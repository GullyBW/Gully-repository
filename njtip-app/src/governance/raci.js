...
function controlOwnership(fitnessIds = []) {
  const byPrefix = [
    ...
    { match: /^APP-FIT-CHAOS|^APP-FIT-RESILIENCE|^APP-FIT-NATIONAL-RESILIENCE|^APP-FIT-RECOVERY|^APP-FIT-MULTI-REGION|^APP-FIT-CONSISTENCY|^APP-FIT-CRISIS|^APP-FIT-OPERATIONS-TWIN/, context: 'resilience' },
    ...
    { match: /^APP-FIT-CONTEXT-MAP|^APP-FIT-MIGRATION|^APP-FIT-ADR|^APP-FIT-CONTINUOUS-ASSURANCE|^APP-FIT-EVIDENCE|^APP-FIT-READINESS|^APP-FIT-ENGINEERING|^APP-FIT-ENTERPRISE|^FIT-AUDITABILITY/, context: 'assurance' },
